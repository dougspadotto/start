...
def _get_ml_config_value(env, key):
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"yape-mlstacks-2 have been deployed to {env} (see yape-mlstacks-2"
...
def get_model_name(env, test_mode=False):
    ...
    if env == "dev" or test_mode:
        ...
        return f"yape-mlstacks-2-model{resource_name_suffix}"
    else:
        # Read ml model name from yape-mlstacks-2/terraform
        return _get_ml_config_value(env, "yape-mlstacks-2_model_name")
