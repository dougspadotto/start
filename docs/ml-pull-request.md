...
* [Staging workspace registered model](https://adb-6832525285606128.8.azuredatabricks.net#mlflow/models/staging-yape-mlstacks-2-model)
* [Prod workspace registered model](https://adb-2529239831454482.2.azuredatabricks.net#mlflow/models/prod-yape-mlstacks-2-model)
