...
[ML Config](../yape-mlstacks-2/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts yape-mlstacks-2/terraform/README.md
...
* [databricks-test.yaml](../yape-mlstacks-2/training/profiles/databricks-test.yaml): specify recipe configs to use in integration tests
* [databricks-staging.yaml](../yape-mlstacks-2/training/profiles/databricks-staging.yaml): specify recipe configs to use in recurring model training and batch inference
  jobs that run in the staging workspace
* [databricks-prod.yaml](../yape-mlstacks-2/training/profiles/databricks-prod.yaml) specify recipe configs to use in recurring model training and batch inference
  jobs that run in the prod workspace

## Merge a PR with your initial ML code
Create and push a PR branch adding the ML code to the repository.
We recommend including all files outside of `yape-mlstacks-2/terraform` in this PR:

```
git checkout -b add-ml-code
git add -- . ':!yape-mlstacks-2/terraform'
...
Follow the instructions in [yape-mlstacks-2/terraform/README.md](../yape-mlstacks-2/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../yape-mlstacks-2/terraform/README.md) to propose, test, and deploy
