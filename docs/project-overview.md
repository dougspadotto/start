...
```
yape-mlstacks-2         <- Root directory. Both monorepo and polyrepo are supported.
│
├── yape-mlstacks-2       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
